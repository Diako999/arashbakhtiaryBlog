...
""".strip(),
            ...
            dict(
                ...
                title_fa="چرا جستجوی سایتتون کند شده و چطور با Postgres درستش کنید",
                title_ckb="بۆچی گەڕانی ماڵپەڕەکەت هێواش بووە و چۆن بە Postgres چاکی بکەیتەوە",
                excerpt_fa="اگه جستجو رو با annotate روی هر ریکوئست حساب می‌کنید، دارید هزینه‌ی محاسبه رو هر بار دوباره پرداخت می‌کنید. راه‌حل ساده‌تر از چیزیه که فکر می‌کنید.",
                excerpt_ckb="ئەگەر گەڕان بە annotate لەسەر هەر داواکارییەک دەژمێریت، تۆ هەر جارە تێچووی ژمێریارییەکە دووبارە دەدەیتەوە.",
                body_fa="""
<p>یه اشتباه رایج که تقریباً همه باهاش شروع می‌کنن: <code>SearchVector("title", "body")</code> رو مستقیم توی queryset یه ویو می‌ذارن و فکر می‌کنن کارشون تمومه. برای چند صد رکورد اول هیچ مشکلی حس نمی‌شه.</p>
<h2>مشکل از کجا شروع می‌شه</h2>
<p>وقتی annotate روی هر ریکوئست اجرا می‌شه، Postgres باید <code>to_tsvector</code> رو برای هر ردیف، توی هر جستجو، از نو محاسبه کنه. نه ایندکسی، نه کشی — فقط محاسبه‌ی خام روی هر درخواست.</p>
<h2>راه‌حل: ستون ذخیره‌شده + GIN Index</h2>
<ol>
<li>یه <code>SearchVectorField</code> به مدل اضافه کنید</li>
<li>یه <code>GinIndex</code> روی همون فیلد بسازید</li>
<li>مقدارش رو موقع ذخیره، نه موقع جستجو، محاسبه کنید</li>
</ol>
<p>نتیجه؟ جستجو از یه محاسبه‌ی O(n) روی هر ریکوئست تبدیل می‌شه به یه lookup ایندکس‌شده. تفاوتش رو با چند هزار رکورد واقعاً حس می‌کنید.</p>
""".strip(),
                body_ckb="""
<p>هەڵەیەکی باو کە هەموان پێی دەست پێدەکەن: <code>SearchVector("title", "body")</code> ڕاستەوخۆ لە queryset دادەنێن و وا بیر دەکەنەوە کارەکەیان تەواو بووە. بۆ چەند سەد تۆماری یەکەم هیچ کێشەیەک هەست پێ ناکرێت.</p>
<h2>کێشەکە لەکوێوە دەست پێدەکات</h2>
<p>کاتێک annotate لەسەر هەر داواکارییەک جێبەجێ دەبێت، Postgres پێویستە <code>to_tsvector</code> بۆ هەر ڕیزێک، لە هەر گەڕانێکدا، لە نوێوە بژمێرێت.</p>
<h2>چارەسەر: ستوونی پاشەکەوتکراو + GIN Index</h2>
<p>ئەنجامەکە؟ گەڕان لە ژمێریارییەکی O(n) لەسەر هەر داواکارییەک دەگۆڕدرێت بۆ گەڕانێکی ئیندێکسکراو.</p>
""".strip(),
