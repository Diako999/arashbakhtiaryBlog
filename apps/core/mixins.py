class SeoContextMixin:
    """Adds seo_title/seo_description to template context.

    Falls back to self.object's meta_title/meta_description (if the view has
    a detail object with those fields) then to seo_title/seo_description
    attributes set on the view class.
    """
