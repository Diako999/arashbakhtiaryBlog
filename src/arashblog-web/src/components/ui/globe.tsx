...
// Texture is self-hosted (see src/assets/images/globe.jpg) rather than
// fetched from a third-party CDN, same reasoning as the self-hosted
// Vazirmatn font: the audience is Iran-based, where external hosts can be
// slow or blocked.
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${globeTexture})`,
